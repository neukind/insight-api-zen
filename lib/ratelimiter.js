...
// temporary solution to increase number of request
// there is a better way is to provide a whitelist ip
// but since heroku have multiple ips, for now use a hard-coded 
// number
const TOTAL_NORMAL_REQUEST_LIMIT = 3 * 60 * 60 * 3 // original number:  3 * 60 * 60 // 10,800
/**
...
function RateLimiter(options) {
  ...
  this.config = {
    ...
    normal: {
      totalRequests: options.limit || TOTAL_NORMAL_REQUEST_LIMIT,
